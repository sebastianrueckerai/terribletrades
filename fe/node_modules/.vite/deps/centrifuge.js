...
var require_centrifuge = __commonJS({
  "node_modules/centrifuge/build/centrifuge.js"(exports) {
    ...
    var Centrifuge = class extends events_1.default {
      ...
      _setNetworkEvents() {
        ...
        if (eventTarget) {
          eventTarget.addEventListener("offline", () => {
            ...
            if (this.state === types_1.State.Connected || this.state === types_1.State.Connecting) {
              this._disconnect(codes_1.connectingCodes.transportClosed, "transport closed", true);
            }
          });
